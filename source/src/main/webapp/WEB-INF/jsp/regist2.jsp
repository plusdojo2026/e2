...
<body>
	<div class="phone-frame">
		...
		<!-- フォーム -->
		<div class="content">
			<form id="expenditureForm" action="Regist2Servlet" method="post">
				<div class="tabs">
					<button type="button" class="tab active"
						onclick="location.href='Regist2Servlet'">収入</button>
					<button type="button" class="tab"
						onclick="location.href='Regist1Servlet'">支出</button>
					<button type="button" class="tab"
						onclick="location.href='Regist3Servlet'">我慢</button>
				</div>
				...
				<div class="form-row">
					<div class="field-group">
						...
						<div class="field-wrap">
							...
							<input class="input-field" type="date" id="created_at"
								name="created_at" placeholder="日付を入力してください" value="">
					...
					<div class="field-group2">
						<!-- 感情ボタン -->
						<div class="field-wrap" style="margin: 0 0 0 auto;">
	...
	<div class="modal-overlay" id="emotionModal">
		<div class="modal-card">
			...
			<div class="emotion-grid">
				<button type="button" class="emotion-opt" data-val="1">😊
					嬉しい</button>
				<button type="button" class="emotion-opt" data-val="2">😐
					普通</button>
				<button type="button" class="emotion-opt" data-val="3">😔
					後悔</button>
				<button type="button" class="emotion-opt" data-val="4">😌
					満足</button>
			</div>
